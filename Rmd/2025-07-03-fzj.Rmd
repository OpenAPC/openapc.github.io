...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.161.4-3-0/data/fzj/oapk_2023_fzj_-_zb_enriched.csv"))
...
```{r additional_costs_fzj_2025_07_03_full, echo = FALSE, message = FALSE}
...
```{r box_fzj_2025_07_03_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2025_07_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
