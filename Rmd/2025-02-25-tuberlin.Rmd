...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.146.4-5-1/data/tuberlin/oapk_2023_tu_berlin_enriched.csv"))
...
```{r tree_tuberlin_2025_02_25_full}
...
```{r box_tuberlin_2025_02_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuberlin_2025_02_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
