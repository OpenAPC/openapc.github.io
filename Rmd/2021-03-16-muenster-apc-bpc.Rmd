...
my.bpc <- download_bpc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimuenster/ULB-Muenster_Open-Access-Fonds_BPC_Kosten_2020_enriched.csv"))
my.bpc <- droplevels(my.bpc)

my.apc <- download_bpc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimuenster/ULB-Muenster_Open-Access-Fonds_APC_Kosten_2020_enriched.csv"))
...
```{r tree_muenster_2021_03_16_apc_full}
...
```{r box_muenster_2021_03_16_apc_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
...
```{r tree_muenster_2021_03_16_bpc_full}
...
```{r box_muenster_2021_03_16_bpc_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.bpc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
