...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$period == 2017 & my.apc$institution %in% c("IRSTEA","INRIA","IFSTTAR","Université de Franche-Comté"),]
...
```{r tree_couperin_2018_11_26_full}
...
```{r box_couperin_2018_11_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
