...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/APC-2020_enriched.csv"))
...
```{r box_hzdr_2021_07_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2021_07_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
