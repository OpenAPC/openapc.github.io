...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$period == 2017 & my.apc$institution %in% c("Université de Lorraine", "Université Lille 2", "Université de Bordeaux", "Université Evry Val-d'Essonne"),]
...
```{r tree_couperin_2018_12_05_full}
...
```{r box_couperin_2018_12_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
