...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/lmu/oapk_2022_muenchen_lmu_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Muenchen LMU",]
my.apc_new <- droplevels(my.apc_new)
```

The contribution covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r box_lmu_2023_12_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_lmu_2023_12_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
