...
```{r tree_fuberlin_2020_09_03_bpc_full}
...
```{r box_fuberlin_2020_09_03_bpc_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2020_09_03_bpc_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.bpc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
