...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/open_APC_2022_tuhh_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Hamburg TUHH",]
...
```{r box_tuhh_2023_03_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2023_03_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
