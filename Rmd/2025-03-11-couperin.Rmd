...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.6-4-1/data/apc_de.csv"))
my.apc <- my.apc[237482:238900,]
...
```{r tree_couperin_2025_03_11_full}
...
```{r box_couperin_2025_03_11_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
