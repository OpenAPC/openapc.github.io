...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20220420_enriched.csv"))
...
```{r tree_oldenburg_2022_04_22_full}
...
```{r box_oldenburg_2022_04_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2022_04_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
