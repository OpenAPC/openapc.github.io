...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.3-2-1-fixed/data/unimilano/openapc_unimi_2025_jan-jun17_enriched.csv"))
...
```{r tree_milano_u_2025_06_18_full}
...
```{r box_milano_u_2025_06_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_milano_u_2025_06_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
