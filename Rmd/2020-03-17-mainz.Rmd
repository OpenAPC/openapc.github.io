...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/Daten-OpenAPC-2019-1_enriched.csv"))
my.apc_new <- my.apc_new[48:95,]
...
```{r box_mainz_2020_03_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2020_03_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
