...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/ETHZ_OpenAPC_2022_enriched.csv"))
...
```{r box_ethz_2023_02_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2023_02_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
