...
```{r tree_openapc_se_2019_08_02_full}
...
```{r box_openapc_se_2019_08_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_openapc_se_2019_08_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
