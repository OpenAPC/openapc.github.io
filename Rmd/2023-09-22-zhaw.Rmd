...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/zhaw/2023-09-14_Datenlieferung_APC_ZHAW_enriched.csv"))
...
```{r box_zhaw_2023_09_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zhaw_2023_09_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
