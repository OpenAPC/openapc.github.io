...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/mluhalle/openAPC_MLU_2020_enriched.csv"))
...
```{r box_mlu_2021_07_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mlu_2021_07_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
