...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unitrier/OpenAPC-Universität_Trier_2021-2022_enriched.csv"))
...
```{r box_trier_2023_05_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_trier_2023_05_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
