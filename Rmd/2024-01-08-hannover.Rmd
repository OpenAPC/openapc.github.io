...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unihannover/oapk_2022_hannover_u_enriched.csv"))
...
```{r tree_hannover_2024_01_08_full}
...
```{r box_hannover_2024_01_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hannover_2024_01_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
