...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "HAWK Hildesheim/Holzminden/Göttingen",]
...
```{r box_hawk_2024_10_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hawk_2024_10_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
