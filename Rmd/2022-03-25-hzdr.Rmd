...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/APC-2021_enriched.csv"))
...
```{r box_hzdr_2022_03_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2022_03_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
