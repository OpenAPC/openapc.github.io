...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/DatenAPC-Gold-2021_enriched.csv"))
...
```{r box_mainz_2022_04_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2022_04_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
