...
The new data covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in Springer Nature Gold OA journals, total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. 
...
```{r box_mainz_2023_02_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2023_02_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
