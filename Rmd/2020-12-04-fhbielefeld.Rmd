...
```{r tree_fhbielefeld_2020_12_04_full}
...
```{r box_fhbielefeld_2020_12_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fhbielefeld_2020_12_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
