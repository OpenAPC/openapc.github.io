...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/lmu/Open_APC_LMU_2020_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Muenchen LMU",]
my.apc_new <- droplevels(my.apc_new)
```

The recent contribution covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in Springer, Frontiers and Wiley OA journals by LMU researchers in 2020. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r box_lmu_2021_03_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_lmu_2021_03_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
