...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20200316_enriched.csv"))
...
```{r tree_oldenburg_2020_03_17_full}
...
```{r box_oldenburg_2020_03_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2020_03_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
