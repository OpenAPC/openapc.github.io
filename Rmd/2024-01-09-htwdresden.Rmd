...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/htwdresden/oapk_2022_htw_dresden_enriched.csv"))
...
```{r box_htw_2024_01_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_htw_2024_01_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
