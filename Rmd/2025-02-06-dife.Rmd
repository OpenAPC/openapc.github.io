...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "DIfE",]
my.apc$publisher <- gsub("Association for Research in Vision and Ophthalmology \\(ARVO\\)", "ARVO", my.apc$publisher)
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.144.2-2-1/data/dife/oapk_2023_dife_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "DIfE",]
...
```{r box_dife_2025_02_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dife_2025_02_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
