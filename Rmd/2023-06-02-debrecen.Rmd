...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unidebrecen/OpenAPC_2022_University_of_Debrecen-HU_enriched.csv"))
...
```{r tree_debrecen_2023_06_02_full}
...
```{r box_debrecen_2023_06_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_debrecen_2023_06_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
