...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibayreuth/oapk_2022_bayreuth_u_enriched.csv"))
...
```{r tree_bayreuth_2023_12_21_full}
...
```{r box_bayreuth_2023_12_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bayreuth_2023_12_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
