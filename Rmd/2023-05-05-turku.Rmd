...
my.apc <- read.csv("../../openapc-de/data/apc_de.csv")
my.apc <- my.apc[my.apc$institution == "University of Turku",]
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/OA-kosken-Univesität_von_Turku_perioden02-03-2022_enriched.csv"))
...
```{r box_turku_2023_05_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2023_05_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
