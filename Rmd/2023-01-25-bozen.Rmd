...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibozen/APC_2022_unibz_enriched.csv")
...
```{r box_bozen_2023_01_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bozen_2023_01_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
