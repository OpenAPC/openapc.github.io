...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unisiegen/Datenlieferung_Open_APC_Universit%C3%A4t_Siegen_2021_APC_enriched.csv"))
...
```{r box_siegen_2022_06_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_siegen_2022_06_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
