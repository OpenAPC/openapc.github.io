...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charlesuniversity/OpenAPC_dataset_2022-APC_enriched.csv"))
...
The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2022. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_charles_2023_12_13_full}
...
```{r box_charles_2023_12_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charles_2023_12_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
