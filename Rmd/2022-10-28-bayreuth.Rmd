...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibayreuth/apc_de-enriched.csv"))
my.apc_new <- my.apc_new[1:138,]
...
```{r tree_bayreuth_2022_10_28_full}
...
```{r box_bayreuth_2022_10_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bayreuth_2022_10_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
