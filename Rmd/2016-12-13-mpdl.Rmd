...
The new data covers publication fees for `r format(nrow(my.apc_2016_njp), big.mark =",")` NJP articles published by MPG researchers, which MPDL covered in 2016 so far. Total expenditure amounts to `r sum(my.apc_2016_njp$euro)`€ and the average fee is `r sum(my.apc_2016_njp$euro)/nrow(my.apc_2016_njp)`€.
...
```{r box_mpdl_2016_12_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
