...
With 19 new articles included, the dataset now covers publication fees for `r format(nrow(my.apc), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc$euro)`€ and the average fee is `r sum(my.apc$euro)/nrow(my.apc)`€.
...
```{r tree_oldenburg_2017_03_02_full}
...
```{r box_oldenburg_2017_03_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2017_03_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
