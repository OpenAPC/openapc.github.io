...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikiel/Open_APC_CAU_Kiel_2021_DFG_2_enriched.csv"))
...
```{r box_kiel_2022_04_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_kiel_2022_04_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
