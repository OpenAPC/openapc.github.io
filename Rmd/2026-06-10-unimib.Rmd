...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.3.47-42-16/data/unimilano-bicocca/UNIMIB_APC-dataset_2025_enriched.csv"))
...
```{r box_unimib_2026_06_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_unimib_2026_06_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
