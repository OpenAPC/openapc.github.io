...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "TU Clausthal" & my.apc$period == 2015, ]
...
```{r box_clausthal_year_2016-05-11, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_clausthal_publisher_2016-05-11, echo = FALSE, message = FALSE}
require(ggplot2)
