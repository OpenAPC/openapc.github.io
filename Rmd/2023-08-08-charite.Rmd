...
my.apc_wiley <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charite/2022_openapc_charite_sn-deal_gold_enriched.csv"))
my.apc_sn <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charite/2022_openapc_charite_wiley-deal_gold_enriched.csv"))
...
```{r tree_charite_2023_08_08_full}
...
```{r box_charite_2023_08_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charite_2023_08_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
