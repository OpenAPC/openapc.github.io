...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.101.6-0-0/data/tudresden/oapk_2022_tu_dresden_enriched.csv"))
...
```{r tree_dresden_2023_12_15_full}
...
```{r box_dresden_2023_12_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dresden_2023_12_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
