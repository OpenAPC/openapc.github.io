...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unireg/new_articles_2020_01_09_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "University of Regensburg",]
...
```{r tree_regensburg_2020_01_09_full}
...
```{r box_regensburg_2020_01_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_regensburg_2020_01_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
