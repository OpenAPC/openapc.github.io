...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniheidelberg/oapk_2022_heidelberg_u_enriched.csv"))
...
```{r tree_heidelberg_2024_01_08_full}
...
```{r box_heidelberg_2024_01_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_heidelberg_2024_01_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
