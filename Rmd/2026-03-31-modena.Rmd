...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimodena/260325_OPENAPC_Unimore_24-25_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Università degli Studi di Modena e Reggio Emilia",]
my.apc_new <- droplevels(my.apc_new)
```

The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. BPCs are aggregated in OpenAPC's [BPC](https://github.com/OpenAPC/openapc-de/blob/master/data/bpc.csv) dataset and are not listed here.
...
```{r box_modena_2026_03_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_modena_2026_03_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
