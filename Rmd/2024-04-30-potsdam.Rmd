...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unipotsdam/potsdam_u_enriched.csv")
my.apc_new <- my.apc_new[my.apc_new$institution == "Potsdam U",]
...
```{r tree_potsdam_2024_04_30_full}
...
```{r box_potsdam_2024_04_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_potsdam_2024_04_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
