...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-IÖR",]
my.apc <- droplevels(my.apc)
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.161.6-6-0/data/ioer/oapk_2023_leibniz-i%C3%B6r_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-IÖR",]
...
```{r box_ioer_2025_07_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ioer_2025_07_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
