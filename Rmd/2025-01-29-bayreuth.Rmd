...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.142.4-3-2/data/unibayreuth/oapk_2023_bayreuth_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Bayreuth U",]
...
```{r tree_bayreuth_2025_01_29_full}
...
```{r box_bayreuth_2025_01_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bayreuth_2025_01_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
