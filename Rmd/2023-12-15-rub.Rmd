...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/rub/oapk_2022_bochum_u_enriched.csv"))
...
```{r box_rub_2023_12_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rub_2023_12_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
