...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.139.2-1-0/data/ash_berlin/oapk_2023_ash_berlin_enriched.csv"))
...
```{r box_ash_2025_01_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ash_2025_01_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
