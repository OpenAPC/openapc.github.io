...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniliege/OpenAPC_articles_2022_enriched.csv"))
...
```{r box_liege_2023_09_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_liege_2023_09_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
