...
```{r tree_barcelona_2017_03_31_full}
...
```{r box_barcelona_2017_03_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_barcelona_2017_03_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
