...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikonstanz/Uni_Konstanz_Meldung_OpenAPC_2021_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Konstanz U",]
...
```{r tree_konstanz_2023_10_24_full}
...
```{r box_konstanz_2023_10_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_konstanz_2023_10_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
