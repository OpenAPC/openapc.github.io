...
my.apc_new <- my.apc_new[226892:226930,]
...
```{r tree_salzburg_2024_10_10_full}
...
```{r box_salzburg_2024_10_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2024_10_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
