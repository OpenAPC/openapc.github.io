...
my.apc_new_1 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/OA-kosken_Universität_von_Turku_ENDE2021_enriched.csv"))
my.apc_new_2 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/OA-kosten_Universität_von_Turku-anfang2022_enriched.csv"))
...
```{r box_turku_2022_09_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2022_09_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
