...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20221124_enriched.csv"))
...
```{r tree_oldenburg_2022_11_24_full}
...
```{r box_oldenburg_2022_11_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2022_11_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
