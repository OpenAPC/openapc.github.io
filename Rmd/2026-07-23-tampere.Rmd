...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/heads/master/data/unitampere/2025_APC_Tampere_University_enriched.csv"))
...
```{r tree_tampere_2026_07_27_full}
...
```{r box_tampere_2026_07_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tampere_2026_07_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
