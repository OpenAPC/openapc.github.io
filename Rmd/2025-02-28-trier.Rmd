...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.146.5-7-1/data/unitrier/oapk_2023_trier_u_enriched.csv"))
...
```{r box_trier_2025_02_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_trier_2025_02_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
