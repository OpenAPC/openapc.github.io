...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/APC_FU_Berlin_2020_enriched.csv"))
...
```{r tree_fuberlin_2021_02_19_full}
...
```{r box_fuberlin_2021_02_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2021_02_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
