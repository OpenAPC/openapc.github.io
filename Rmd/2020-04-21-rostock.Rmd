...
```{r tree_rostock_2020_04_21_full}
...
```{r box_rostock_2020_04_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rostock_2020_04_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
