...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unidue/oapk_2022_duisburg-essen_u_enriched.csv"))
...
```{r box_due_2024_01_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_due_2024_01_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
