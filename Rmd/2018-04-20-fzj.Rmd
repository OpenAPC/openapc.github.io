...
my.apc_2017 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fzj/FZJ2017_enriched.csv"))
...
```{r box_fzj_2018_04_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2018_04_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
