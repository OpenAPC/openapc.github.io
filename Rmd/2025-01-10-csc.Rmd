...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.137.1-0-1/data/csc/journals_enriched.csv"))
...
```{r box_csc_2025_01_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_csc_2025_01_10_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
