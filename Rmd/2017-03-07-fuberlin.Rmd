...
FU Berlin's final APC expenditures for 2016 now include `r format(nrow(my.apc_2016), big.mark =",")` articles, amounting to `r sum(my.apc_2016$euro)`€ and an average fee of `r sum(my.apc_2016$euro)/nrow(my.apc_2016)`€.
...
```{r tree_fuberlin_2017_03_07_full}
...
```{r box_fuberlin_2017_03_07_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2017_03_07_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
