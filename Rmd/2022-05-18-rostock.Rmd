...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Rostock U",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unirostock/2022-05-17_Universitaet_Rostock_APC_2020_2021_geschickt_final_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Rostock U",]
...
```{r tree_rostock_2022_05_18_full}
...
```{r box_rostock_2022_05_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rostock_2022_05_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
