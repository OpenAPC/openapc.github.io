...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/phzh/OpenAPC_PHZH_2023_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Pädagogische Hochschule Zürich",]
my.apc_new <- droplevels(my.apc_new)

```

The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` article. The data also contained 1 BPC record which is not listed here as BPCs are aggregated in OpenAPC's [BPC](https://github.com/OpenAPC/openapc-de/blob/master/data/bpc.csv) dataset. 
...
```{r box_phzh_2024_03_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_phzh_2024_03_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
