...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unihannover/unihannover_enriched.csv"))
my.apc_new <- my.apc_new[417:562,]
my.apc_new <- my.apc_new[my.apc_new$institution == "Hannover U",]
...
```{r tree_hannover_2022_03_30_full}
...
```{r box_hannover_2022_03_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hannover_2022_03_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
