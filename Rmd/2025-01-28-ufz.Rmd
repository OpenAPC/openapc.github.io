...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.142.2-2-1/data/ufz/oapk_2023_ufz_enriched.csv"))
...
```{r box_ufz_2025_01_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ufz_2025_01_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
