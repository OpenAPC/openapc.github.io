...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "TH Ingolstadt",]
...
```{r tree_th_ingolstadt_2025_02_28_full}
...
```{r box_th_ingolstadt_2025_02_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
