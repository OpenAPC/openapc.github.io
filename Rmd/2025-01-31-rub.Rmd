...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Bochum U",]
my.apc$publisher <- gsub("Association for Research in Vision and Ophthalmology \\(ARVO\\)", "ARVO", my.apc$publisher)
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.142.7-5-2/data/rub/oapk_2023_bochum_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Bochum U",]
...
```{r box_rub_2025_01_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rub_2025_01_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
...
q + xlab("Publisher (> 7 article)") + ylab("APC")
```
