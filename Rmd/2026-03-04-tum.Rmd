...
my.apc$publisher <- gsub("Verein zur Forderung des Open Access Publizierens in den Quantenwissenschaften", "Verein Quantenwissenschaften", my.apc$publisher)
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tum/TUM_2024_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Muenchen",]
...
```{r box_tum_2026_03_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tum_2026_03_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
