...
The GFZ's APC expenditures for 2016 include `r format(nrow(my.apc_2016), big.mark =",")` articles, amounting to `r format(sum(my.apc_2016$euro), big.mark=",")`€ and an average fee of `r format(sum(my.apc_2016$euro)/nrow(my.apc_2016), big.mark=",")`€.
...
```{r box_gfz_2017_02_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_gfz_2017_02_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
