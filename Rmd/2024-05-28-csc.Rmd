...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.124.12-5-3/data/csc/journals_enriched.csv"))
...
```{r box_csc_2024_05_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_csc_2024_05_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
