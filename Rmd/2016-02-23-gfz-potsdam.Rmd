...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "GFZ-Potsdam" & my.apc$period == 2015, ]
my.apc_2015 <- droplevels(my.apc_2015)
my.apc <- my.apc[my.apc$institution == "GFZ-Potsdam", ]
my.apc <- droplevels(my.apc)
```

The new dataset covers publication fees for `r format(nrow(my.apc_2015), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_2015$euro)`€ and the average fee is `r sum(my.apc_2015$euro)/nrow(my.apc_2015)`€.
...
```{r box_gfz_potsdam_year-2016-02-23, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_gfz_potsdam_publisher-2016-02-23, echo = FALSE, message = FALSE}
require(ggplot2)
