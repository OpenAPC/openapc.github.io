...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "Dortmund TU" & my.apc$period == 2015, ]
...
```{r box_dortmund_year_2016-06-09, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dortmund_publisher_2016-06-09, echo = FALSE, message = FALSE}
require(ggplot2)
