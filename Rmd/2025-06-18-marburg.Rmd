...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.4-3-2/data/unimarburg/oapk_2023_marburg_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Marburg U" & !is.na(my.apc_new$institution),]
...
```{r tree_marburg_2025_06_18_full}
...
```{r box_marburg_2025_06_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_marburg_2025_06_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
