...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.160.8-7-1/data/unikiel/oapk_2023_kiel_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Kiel U",]
...
```{r box_kiel_2025_06_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_kiel_2025_06_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
