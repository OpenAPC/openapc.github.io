...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.163.5-3-1/data/apc_de.csv"))
my.apc <- my.apc[250818:250896,]
...
```{r tree_couperin_2025_07_24_full}
...
```{r box_couperin_2025_07_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
