...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.165.1-0-1/data/apc_de.csv"))
my.apc <- my.apc[253854:254087,]
...
```{r tree_couperin_2025_10_01_full}
...
```{r box_couperin_2025_10_01_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
