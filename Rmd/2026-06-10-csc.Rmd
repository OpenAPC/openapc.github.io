...
download_apc <- function(path = NULL, dir = "tmp", file = "apc_de.csv"){
  if(is.null(path)) {
    path <- c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v5.3.44-41-14/data/apc_de.csv")
    } 
  dir.create(dir) 
...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.3.44-41-14/data/csc/journals_enriched.csv"))
...
The updated data set provided by the CSC covers publication fees for `r format(nrow(my.apc), big.mark =",")` articles published between 2013 and 2026, replacing the previous CSC data. Total expenditure amounts to `r sum(my.apc$euro)`€ and the average fee is `r sum(my.apc$euro)/nrow(my.apc)`€.
...
```{r box_csc_2026_06_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_csc_2026_06_10_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
