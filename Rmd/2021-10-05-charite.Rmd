...
my.apc_wiley <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charite/2020_openapc_charite_wiley-deal_gold_enriched.csv"))
my.apc_sn <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charite/2020_openapc_charite_sn-deal_gold_enriched.csv"))
my.apc_new <- rbind(my.apc_wiley, my.apc_sn)
my.apc_new <- droplevels(my.apc_new)

```
The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in Springer Nature and Wiley Gold OA journals, total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. Please note that articles published in **hybrid** journals under the DEAL agreement are not included in this list, as they are aggregated in OpenAPC's [transformative agreements data set](https://github.com/OpenAPC/openapc-de/tree/master/data/transformative_agreements).
...
```{r tree_charite_2021_10_05_full}
...
```{r box_charite_2021_10_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charite_2021_10_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
