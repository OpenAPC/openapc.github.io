...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tudresden/Data_OpenAPC_TU_Dresden_2021_enriched.csv"))
...
```{r tree_dresden_2022_03_29_full}
...
```{r box_dresden_2022_03_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dresden_2022_03_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
