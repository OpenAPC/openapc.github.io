...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/WileyAPCgold-2021_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "JGU Mainz",]
my.apc_new <- droplevels(my.apc_new)
```

The new data covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in Wiley Gold OA journals, total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. 
...
```{r box_mainz_2023_02_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2023_02_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
