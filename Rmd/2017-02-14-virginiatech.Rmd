...
```{r tree_virginatech_2017_02_14_full}
...
```{r box_virginatech_2017_02_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_virginatech_2017_02_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
