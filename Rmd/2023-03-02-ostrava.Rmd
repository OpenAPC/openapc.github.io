...
```{r tree_ostrava_2023-03-02_full}
...
```{r box_ostrava_2023-03-02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ostrava_2023-03-02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
