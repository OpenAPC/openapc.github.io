...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.163.9-5-3-fixed/data/apc_de.csv"))
my.apc <- my.apc[251007:251196,]
my.apc <- my.apc[my.apc$institution != "",]
my.apc$publisher <- gsub("Verein zur Forderung des Open Access Publizierens in den Quantenwissenschaften", "VFOAPQ", my.apc$publisher)
...
```{r tree_couperin_2025_07_30_full}
...
```{r box_couperin_2025_07_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
