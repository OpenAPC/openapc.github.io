...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/dlr/DLRopenAPC_2023_enriched.csv"))
...
```{r box_dlr_2024_06_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dlr_2024_06_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
