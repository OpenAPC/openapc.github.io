...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fwf/fwf_2018_enriched.csv"))
...
```{r box_fwf_2019_06_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fwf_2019_06_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
