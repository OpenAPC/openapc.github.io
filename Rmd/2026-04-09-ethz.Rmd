...
my.apc$publisher <- gsub("Institution of Engineering and Technology \\(IET\\)", "IET", my.apc$publisher)
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/ETHZ_OpenAPC_2025_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "ETH Zurich" & !is.na(my.apc_new$institution),]
...
```{r box_ethz_2026_04_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2026_04_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
