...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.125.1-0-0/data/apc_de.csv"))
my.apc <- my.apc[223217:223297,]
...
```{r tree_couperin_2024_06_13_full}
...
```{r box_couperin_2024_06_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
