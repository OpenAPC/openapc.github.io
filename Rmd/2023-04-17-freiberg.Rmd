...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tufreiberg/TUBAF_2022_enriched.csv"))
...
```{r tree_freiberg_2023_04_17_full}
...
```{r box_freiberg_2023_04_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_freiberg_2023_04_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
