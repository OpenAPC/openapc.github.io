...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/mluhalle/2022_openAPC_MLU_2021_final_enriched.csv"))
...
```{r box_mlu_2022_06_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mlu_2022_06_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
