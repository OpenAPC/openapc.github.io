...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/zhaw/2025-09-05_Datenlieferung_APC_ZHAW_enriched.csv"))
...
```{r box_zhaw_2025_10_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zhaw_2025_10_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
