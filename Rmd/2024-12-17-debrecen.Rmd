...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unidebrecen/UD-HU_2023-OpenAPC-fin_enriched.csv"))
...
```{r tree_debrecen_2024_12_17_full}
...
```{r box_debrecen_2024_12_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_debrecen_2024_12_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
