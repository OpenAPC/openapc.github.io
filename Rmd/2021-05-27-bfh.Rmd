...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/bfh/2020_OpenAPC_BernUniversityofAppliedSciences_enriched.csv"))
...
```{r box_bfh_2021_05_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bfh_2021_05_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
