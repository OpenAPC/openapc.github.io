...
```{r tree_freiberg_2023_04_13_full}
...
```{r box_freiberg_2023_04_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_freiberg_2023_04_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
