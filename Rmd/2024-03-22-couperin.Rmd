...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.121.15-10-6/data/apc_de.csv"))
my.apc <- my.apc[207158:208075,]
...
```{r tree_couperin_2024_03_22_full}
...
```{r box_couperin_2024_03_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
