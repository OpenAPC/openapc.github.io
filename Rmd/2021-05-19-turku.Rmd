...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/OA-kosten-periode2-3Universit%C3%A4t-von-Turku-2020_enriched.csv"))
...
```{r box_turku_2021_05_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2021_05_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
