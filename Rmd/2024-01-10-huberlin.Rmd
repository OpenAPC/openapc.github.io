...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/huberlin/oapk_2022_hu_berlin_enriched.csv"))
...
```{r tree_huberlin_2024_01_10_full}
...
```{r box_huberlin_2024_01_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_huberlin_2024_01_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
