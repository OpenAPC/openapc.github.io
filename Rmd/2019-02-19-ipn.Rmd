...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "IPN - Leibniz Kiel",]
my.apc <- droplevels(my.apc)

my.apc_2017 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ipn/2017_IPN_openAPC_enriched.csv"))
my.apc_2017 <- my.apc_2017[!(my.apc_2017$institution == ""),]
my.apc_2017 <- droplevels(my.apc_2017)

my.apc_2018 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ipn/2018_IPN_openAPC_enriched.csv"))
my.apc_2018 <- my.apc_2018[!(my.apc_2018$institution == ""),]
my.apc_2018 <- droplevels(my.apc_2018)

my.apc_new <- rbind(my.apc_2017, my.apc_2018)
...
```{r box_ipn_2019_02_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ipn_2019_02_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
