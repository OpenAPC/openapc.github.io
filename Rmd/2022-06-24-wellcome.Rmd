...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.61.1-0-0/data/wellcome/COAF_2018_19_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution != "",]
my.apc_new <- droplevels(my.apc_new)

my.apc <- rbind(my.apc, my.apc_new)
...
```{r tree_wellcome_2022_06_24_full}
...
```{r box_wellcome_2022_06_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_wellcome_2022_06_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
