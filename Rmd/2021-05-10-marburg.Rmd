...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimarburg/OpenAPCs-2020_UMR_enriched.csv"))
...
```{r tree_marburg_2021_05_10_full}
...
```{r box_marburg_2021_05_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_marburg_2021_05_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
