...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.8-6-1/data/unistuttgart/oapk_2023_stuttgart_u_enriched.csv"))
...
```{r tree_stuttgart_2025_03_12_full}
...
```{r box_stuttgart_2025_03_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_stuttgart_2025_03_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
