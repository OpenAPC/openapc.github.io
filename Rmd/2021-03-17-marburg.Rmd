...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimarburg/OpenAPCs-2019_UMR_enriched.csv"))
...
```{r tree_marburg_2021_03_17_full}
...
```{r box_marburg_2021_03_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_marburg_2021_03_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
