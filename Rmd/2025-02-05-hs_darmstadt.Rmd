...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Darmstadt University of Applied Sciences",]
...
```{r tree_hs_darmstadt_2025_02_17_full}
...
```{r box_hs_darmstadt_2025_02_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
