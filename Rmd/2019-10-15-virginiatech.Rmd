...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Virginia Tech",]
my.apc$publisher <- gsub("International Medical Publisher \\(Fundacion de Neurociencias\\)", "Fundacion de Neurociencias", my.apc$publisher)
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/virginiatech/VirginiaTech2017-2018_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Virginia Tech",]
my.apc_new$publisher <- gsub("International Medical Publisher \\(Fundacion de Neurociencias\\)", "Fundacion de Neurociencias", my.apc_new$publisher)
my.apc_new <- droplevels(my.apc_new)
```

The data covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_virginatech_2019_10_15_full}
...
```{r box_virginatech_2019_10_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_virginatech_2019_10_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
