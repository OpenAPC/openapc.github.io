...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.102.2-0-0/data/apc_de.csv"))
my.apc <- my.apc[195907:196177,]
...
```{r tree_couperin_2023_12_18_full}
...
```{r box_couperin_2023_12_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
