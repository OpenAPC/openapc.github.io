...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.149.4-3-2/data/unimilano/openapc_unimi_2024_enriched.csv"))
...
```{r tree_milano_u_2025_04_07_full}
...
```{r box_milano_u_2025_04_07_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_milano_u_2025_04_07_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
