...
my.apc_full <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.87.3-0-0/data/apc_de.csv"))
my.apc <- my.apc_full[my.apc_full$institution == "Stuttgart U",]
my.apc <- droplevels(my.apc)
my.apc_new_1 <- my.apc_full[154254:154282,]
my.apc_new_2 <- my.apc_full[183327:183476,]
my.apc_new <- rbind(my.apc_new_1, my.apc_new_2)
my.apc_new <- my.apc_new[my.apc_new$institution == "Stuttgart U",]
...
```{r tree_stuttgart_2023_05_08_full}
...
```{r box_stuttgart_2023_05_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_stuttgart_2023_05_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
