...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.119.2-0-0/data/fzj/oapk_2022_fzj_-_zb_enriched.csv"))
...
```{r box_fzj_2024_01_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2024_01_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
