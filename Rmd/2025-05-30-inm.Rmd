...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.154.7-5-2/data/apc_de.csv"))
my.apc_new <- my.apc_new[245559:245565,]
my.apc_new <- my.apc_new[my.apc_new$institution == "INM - Leibniz-Institut für Neue Materialien",]
...
```{r box_inm_2025_05_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_inm_2025_05_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
