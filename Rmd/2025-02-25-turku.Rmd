...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.146.3-4-0/data/uniturku/OA-University-of-Turku-FInland-2023-2024APC_enriched.csv"))
...
```{r box_turku_2025_02_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2025_02_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
