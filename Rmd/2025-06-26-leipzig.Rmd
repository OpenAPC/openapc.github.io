...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.160.3-3-1/data/unileipzig/oapk_2023_leipzig_u_enriched.csv"))
...
```{r tree_leipzig_2025_06_26_full}
...
```{r box_leipzig_2025_06_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_leipzig_2025_06_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
