...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuwien/openapc_tuwien_2021-23_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Wien" & !is.na(my.apc_new$institution),]
...
```{r box_tuwien_2024_02_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuwien_2024_02_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
