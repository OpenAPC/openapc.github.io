...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniheidelberg/openAPC_HeidelbergUniv_03-2018_enriched.csv"))
...
```{r tree_heidelberg_2018_03_12_full}
...
```{r box_heidelberg_2018_03_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_heidelberg_2018_03_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
