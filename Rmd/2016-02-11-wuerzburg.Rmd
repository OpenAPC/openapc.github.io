...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "Wuerzburg U" & my.apc$period == 2015, ]
...
```{r box_wuerzburg_year-2016-02-11, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_wuerzburg_publisher-2016-02-11, echo = FALSE, message = FALSE}
require(ggplot2)
