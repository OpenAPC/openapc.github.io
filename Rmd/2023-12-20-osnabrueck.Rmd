...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniosnabrueck/oapk_2022_osnabr%C3%BCck_u_enriched.csv"))
...
```{r tree_osnabrueck_2023_12_20_full}
...
```{r box_osnabrueck_2023_12_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_osnabrueck_2023_12_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
