...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/haw_hamburg/OpenAPC_HAW_Hamburg_DEAL_Springer_Gold_2021_enriched.csv"))
...
```{r tree_haw_hamburg_2022_07_04_full}
...
```{r box_haw_hamburg_2022_07_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_haw_hamburg_2022_07_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
