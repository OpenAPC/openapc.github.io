...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimannheim/apc-unimannheim-2019s2_enriched.csv")
...
```{r tree_mannheim_2020_01_06_full}
...
```{r box_mannheim_2020_01_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mannheim_2020_01_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
