...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/openAPC_tuhh_2021_enriched.csv"))
...
```{r box_tuhh_2022_04_07_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2022_04_07_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
