...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniheidelberg/OpenAPC_HeidelbergU_Datenlieferung_2020-2_enriched.csv"))
...
```{r tree_heidelberg_2020_02_24_full}
...
```{r box_heidelberg_2020_02_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_heidelberg_2020_02_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
