...
The update provides some corrections to Leipzig's 2015 APC data and extends the dataset. It now contains `r format(nrow(my.apc_2015), big.mark =",")` articles, which the fund covered in 2015 so far. Total expenditure amounts to `r sum(my.apc_2015$euro)`€ and the average fee is `r sum(my.apc_2015$euro)/nrow(my.apc_2015)`€.
...
```{r box_leipzig_year-2016-05-11, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_leipzig_publisher-2016-05-11, echo = FALSE, message = FALSE}
require(ggplot2)
