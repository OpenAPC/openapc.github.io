...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-BIPS",]
my.apc <- droplevels(my.apc)
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.7-6-3/data/bips/oapk_2023_leibniz-bips_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-BIPS",]
...
```{r box_bips_2025_06_23_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bips_2025_06_23_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
