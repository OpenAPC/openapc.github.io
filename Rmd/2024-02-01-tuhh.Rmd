...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/openAPC_2023_tuhh_enriched.csv"))
...
```{r box_tuhh_2024_02_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2024_02_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
