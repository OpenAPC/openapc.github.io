...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/geomar/OpenAPC-GEOMAR-2020_enriched.csv"))
...
```{r box_geomar_2021_03_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_geomar_2021_03_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
