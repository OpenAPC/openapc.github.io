...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimodena/240515_OPENAPC_UNIMORE_22-23_enriched.csv"))
...
```{r box_modena_2024_05_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_modena_2024_05_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
