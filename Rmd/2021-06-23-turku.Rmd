...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/Universit%C3%A4t_Turku-APC-kosten-Jan_April-2021_enriched.csv"))
...
```{r box_turku_2021_06_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2021_06_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
