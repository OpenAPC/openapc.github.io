...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/iov-irccs/OpenAPC2023_IOV_data2022_enriched.csv"))
...
```{r box_iov_2023_04_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_iov_2023_04_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
