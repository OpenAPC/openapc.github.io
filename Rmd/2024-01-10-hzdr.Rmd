...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/oapk_2022_hzdr_enriched.csv"))
...
```{r box_hzdr_2024_01_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2024_01_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
