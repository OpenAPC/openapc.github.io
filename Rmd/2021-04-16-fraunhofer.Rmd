...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Fraunhofer-Gesellschaft Publishing Fund",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fraunhofer/FraunhoferGes_OpenAPC_2019_2020_gold_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Fraunhofer-Gesellschaft Publishing Fund",]
...
```{r tree_fraunhofer_2021_04_16_full}
...
```{r box_fraunhofer_2021_04_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fraunhofer_2021_04_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
