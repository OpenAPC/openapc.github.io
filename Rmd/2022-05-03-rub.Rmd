...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/rub/OA_an_Open_APC_2021neu_enriched.csv"))
...
```{r box_rub_2022_05_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rub_2022_05_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
