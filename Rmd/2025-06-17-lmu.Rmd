...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.1-2-1/data/lmu/oapk_2023_muenchen_lmu_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Muenchen LMU" & !is.na(my.apc_new$institution),]
...
```{r box_lmu_2025_06_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_lmu_2025_06_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
