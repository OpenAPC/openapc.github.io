...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.152.2-2-1/data/unipotsdam/oapk_2023_potsdam_u_enriched.csv"))
...
```{r tree_potsdam_2025_04_22_full}
...
```{r box_potsdam_2025_04_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_potsdam_2025_04_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
