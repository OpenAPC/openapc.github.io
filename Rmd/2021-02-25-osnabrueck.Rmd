...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniosnabrueck/OA_Artikel_2020_INTACT_enriched.csv"))
...
```{r tree_osnabrueck_2021_02_25_full}
...
```{r box_osnabrueck_2021_02_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_osnabrueck_2021_02_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
