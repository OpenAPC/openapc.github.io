...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.144.8-7-3/data/unibern/Reporting_University_of_Bern_OpenAPC_2024_Jul-Dec_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution != "",]
my.apc_new <- droplevels(my.apc_new)

```

The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in the second half of 2024. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r box_bern_2025_02_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bern_2025_02_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
