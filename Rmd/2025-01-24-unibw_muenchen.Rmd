...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Universität der Bundeswehr München",]
...
```{r tree_unibw_muenchen_2025_01_24_full}
...
```{r box_unibw_muenchen_2025_01_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
