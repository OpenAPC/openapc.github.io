...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Regensburg University of Applied Sciences",]
my.apc <- droplevels(my.apc)

```

The initial data set provided by the OTH covers publication fees for `r format(nrow(my.apc), big.mark =",")` articles, total expenditure amounts to `r sum(my.apc$euro)`€ and the average fee is `r sum(my.apc$euro)/nrow(my.apc)`€.
...
```{r tree_oth_regensburg_2025_04_22_full}
...
```{r box_oth_regensburg_2025_04_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
