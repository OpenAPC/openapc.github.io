...
my.apc_2013 <- my.apc[my.apc$period == 2013,]
my.apc_2013 <- droplevels(my.apc_2013)
```

The new dataset covers publication fees for `r format(nrow(my.apc_2013), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_2013$euro)`€ and the average fee is `r sum(my.apc_2013$euro)/nrow(my.apc_2013)`€.

The following table shows the payments Mainz University Library has made to publishers in 2013.

```{r}
d_frame = data.frame(table(my.apc_2013$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]                                           
                                    
my.apc_2013$publisher <- factor(my.apc_2013$publisher, levels =  d_frame$Publisher)
...
```{r box_mainz_2018_08_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2018_08_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
