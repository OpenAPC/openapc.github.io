...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniliege/Open-APC_2021_APCs_enriched.csv"))
...
```{r box_liege_2022_07_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_liege_2022_07_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
