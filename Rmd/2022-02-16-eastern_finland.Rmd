...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unieasternfinland/uef_openapc_2021_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "University of Eastern Finland",]
my.apc_new <- droplevels(my.apc_new)

```

The new data covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2021. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_eastern_finland_2022_02_16_full}
...
```{r box_eastern_finland_2022_02_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_eastern_finland_2022_02_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
