...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "Hamburg TUHH" & my.apc$period == 2015, ]
...
```{r box_tuhh_year-2016-02-19, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_publisher-2016-02-19, echo = FALSE, message = FALSE}
require(ggplot2)
