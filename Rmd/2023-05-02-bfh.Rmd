...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/bfh/2019_OpenAPC_BernUniversityofAppliedSciences_Addition_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Bern University of Applied Sciences",]
...
```{r box_bfh_2023_05_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bfh_2023_05_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
