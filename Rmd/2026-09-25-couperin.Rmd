...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.11.14-12-2/data/apc_de.csv"))
my.apc <- my.apc[268880:269081,]
...
```{r tree_couperin_2026_09_25_full}
...
```{r box_couperin_2026_09_25_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
