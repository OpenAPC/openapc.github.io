...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.136.1-0-0/data/apc_de.csv"))
my.apc <- my.apc[229641:230172,]
...
```{r tree_couperin_2024_12_20_full}
...
```{r box_couperin_2024_12_20_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
