...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20190308_enriched.csv"))
...
```{r tree_oldenburg_2019_03_13_full}
...
```{r box_oldenburg_2019_03_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2019_03_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
