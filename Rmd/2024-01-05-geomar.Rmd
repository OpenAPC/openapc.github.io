...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/geomar/oapk_2022_geomar_enriched.csv"))
...
```{r box_geomar_2024_01_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_geomar_2024_01_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
