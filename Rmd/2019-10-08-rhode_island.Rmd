...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unirhodeisland/University_of_RI_OpenAPC_data_2018-06-07_to_2019-10-03_enriched.csv"))
...
```{r tree_rhode_island_2019_10_08_full}
...
```{r box_rhode_island_2019_10_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rhode_island_2019_10_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
