...
```{r tree_ostrava_2025-03-12_full}
...
```{r box_ostrava_2025-03-12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ostrava_2025-03-12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
