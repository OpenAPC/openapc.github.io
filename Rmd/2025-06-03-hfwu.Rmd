...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Nürtingen-Geislingen University of Applied Science",]
...
```{r box_hfwu_2025_06_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
