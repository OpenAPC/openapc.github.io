...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "VSB - Technical University of Ostrava",]
my.apc$publisher <- gsub("Technical University of Kosice, Faculty of Materials, Metallurgy and Recycling", "TU Kosice", my.apc$publisher)
...
```{r tree_ostrava_2026-02-25_full}
...
```{r box_ostrava_2026-02-25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ostrava_2026-02-25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
