...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/APC-2019_enriched.csv"))
...
```{r box_hzdr_2020_04_08_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2020_04_08_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
