...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.11.10-9-1/data/apc_de.csv"))
my.apc_new <- my.apc_new[268392:268483,]
...
```{r box_turku_2026_09_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2026_09_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
