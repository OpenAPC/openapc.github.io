...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibozen/2020_Open_APC_unibz_DEF_enriched.csv")
...
```{r box_bozen_2021_03_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bozen_2021_03_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
