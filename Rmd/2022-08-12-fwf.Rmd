...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fwf/fwf_openapc_2021_enriched.csv"))
...
```{r box_fwf_2022_08_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fwf_2022_08_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
