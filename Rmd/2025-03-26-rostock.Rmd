...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.16-14-4/data/unirostock/oapk_2023_rostock_u_enriched.csv"))
...
```{r tree_rostock_2025_03_26_full}
...
```{r box_rostock_2025_03_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rostock_2025_03_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
