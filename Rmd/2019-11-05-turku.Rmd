...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/APCDaten_Universitat_Von_Turku_period_Mai_August_2019_CSV_enriched.csv"))
...
```{r box_turku_2019_11_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2019_11_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
