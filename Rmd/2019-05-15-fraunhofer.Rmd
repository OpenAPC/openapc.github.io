...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fraunhofer/FraunhoferGes_OpenAPC_2018_enriched.csv"))
...
```{r tree_fraunhofer_2019_05_15_full}
...
```{r box_fraunhofer_2019_05_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fraunhofer_2019_05_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
