...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/APC_FU_Berlin_2018_enriched.csv"))
...
```{r tree_fuberlin_2019_03_27_full}
...
```{r box_fuberlin_2019_03_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2019_03_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
