...
my.apc_1 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/couperin/ensicaen/OpenAPC_donn%C3%A9es2020_Ensicaen_enriched.csv"))
my.apc_2 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/couperin/antilles/OpenAPC_donn%C3%A9es2017-20_Antilles_enriched.csv"))
my.apc_3 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/couperin/inserm/OpenAPC_donn%C3%A9es_INSERM_2018_enriched.csv"))


my.apc <- rbind(my.apc_1, my.apc_2, my.apc_3)
...
```{r tree_couperin_2021_05_20_full}
...
```{r box_couperin_2021_05_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
