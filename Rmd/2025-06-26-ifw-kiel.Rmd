...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Kiel Institute for the World Economy",]
...
```{r tree_ifw_kiel_2025_06_26_full}
...
```{r box_ifw_kiel_2025_06_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
