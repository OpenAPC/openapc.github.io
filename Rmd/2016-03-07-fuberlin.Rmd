...
With the recent contribution expenditures for 2015 now include `r format(nrow(my.apc_2015), big.mark =",")` articles, which the fund covered in 2015. Total expenditure amounts to `r sum(my.apc_2015$euro)`€ and the average fee is `r sum(my.apc_2015$euro)/nrow(my.apc_2015)`€.
...
```{r box_fuberlin_year-2016-03-07, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_publisher-2016-03-07, echo = FALSE, message = FALSE}
require(ggplot2)
