...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Koeln U",]
my.apc <- droplevels(my.apc)
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.156.5-6-1/data/unikoeln/oapk_2023_koeln_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Koeln U",]
...
```{r box_koeln_2025_06_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_koeln_2025_06_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
