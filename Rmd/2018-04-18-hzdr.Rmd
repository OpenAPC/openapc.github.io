...
my.apc_2017 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/openapc2017_enriched.csv"))
my.apc_2017 <- my.apc_2017[!is.na(my.apc_2017$institution),]
...
```{r box_hzdr_2018_04_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2018_04_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
