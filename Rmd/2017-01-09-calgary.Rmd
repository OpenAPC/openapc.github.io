...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "University of Calgary",]
...
```{r tree_calgary_2017_01_09_full}
...
```{r box_calgary_2017_01_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_calgary_2017_01_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
...
q + xlab("Publisher (> 5 publications)") + ylab("APC")
```
