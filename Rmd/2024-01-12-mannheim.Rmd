...
my.apc$publisher <- gsub("American Institute of Mathematical Sciences \\(AIMS\\)", "AIMS", my.apc$publisher)
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimannheim/oapk_2022_mannheim_u_enriched.csv")
my.apc_new <- my.apc_new[my.apc_new$institution == "Mannheim U",]
...
```{r tree_mannheim_2024_01_12_full}
...
```{r box_mannheim_2022_01_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mannheim_2022_01_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
