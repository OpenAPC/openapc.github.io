...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikonstanz/Meldung_OpenAPC_2020_enriched.csv"))
...
```{r tree_konstanz_2021_04_21_full}
...
```{r box_konstanz_2021_04_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_konstanz_2021_04_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
