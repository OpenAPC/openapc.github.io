...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unirhodeisland/Univ-Rhode-Island-OpenAPC-data-update_enriched.csv"))
...
```{r tree_rhode_island_2023_02_13_full}
...
```{r box_rhode_island_2023_02_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rhode_island_2023_02_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
