...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikiel/oapk_2022_kiel_u_enriched.csv"))
...
```{r box_kiel_2024_01_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_kiel_2024_01_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
...
q + xlab("Publisher (> 2 article)") + ylab("APC")
```
