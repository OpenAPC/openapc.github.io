...
```{r tree_hohenheim_2024_04_17_full}
...
```{r box_hohenheim_2024_04_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hohenheim_2024_04_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
