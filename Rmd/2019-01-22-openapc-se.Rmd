...
```{r tree_openapc_se_2019_01_22_full}
...
```{r box_openapc_se_2019_01_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_openapc_se_2019_01_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
