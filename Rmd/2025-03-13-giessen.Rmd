...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.9-7-1/data/jlu_giessen/oapk_2023_giessen_u_enriched.csv"))
...
```{r tree_giessen_2025_03_13_full}
...
```{r box_giessen_2025_03_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_giessen_2025_03_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
