...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unitampere/Tampere_university_apc_1_1_2020_31_12_2020_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution != "",]
my.apc_new <- droplevels(my.apc_new)

```

The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2020. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_tampere_2021_07_27_full}
...
```{r box_tampere_2021_07_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tampere_2021_07_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
