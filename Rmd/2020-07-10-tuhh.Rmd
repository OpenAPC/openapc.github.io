...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/apc-tuhh-2019-Stand-02-07-2020_enriched.csv"))
...
```{r box_tuhh_2020_07_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2020_07_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
