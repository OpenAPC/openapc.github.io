...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "Bochum U" & my.apc$period == 2015, ]
...
```{r box_bochum_year-2016-02-12, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bochum_publisher-2016-02-12, echo = FALSE, message = FALSE}
require(ggplot2)
