...
my.apc_new <- my.apc[my.apc$period %in% c(2021, 2022) ,]
...
```{r tree_tuebingen_2023_05_26_full}
...
```{r box_tuebingen_2023_05_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuebingen_2023_05_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
