...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.141.3-3-0/data/unibamberg/oapk_2023_bamberg_u_enriched.csv"))
...
```{r tree_bamberg_2025_01_24_full}
...
```{r box_bamberg_2025_01_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bamberg_2025_01_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
