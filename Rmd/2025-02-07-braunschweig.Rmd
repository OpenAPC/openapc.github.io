...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.144.5-5-2/data/tubraunschweig/oapk_2023_tu_braunschweig_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Braunschweig" & !is.na(my.apc_new$institution),]
...
```{r tree_braunschweig_2025_02_07_full}
...
```{r box_braunschweig_2025_02_07_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_braunschweig_2025_02_07_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
