...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unirostock/2025-05-23_OpenAPC_Uni_Rostock_2022_enriched.csv"))
...
```{r tree_rostock_2025_05_30_full}
...
```{r box_rostock_2025_05_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rostock_2025_05_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
