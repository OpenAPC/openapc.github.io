...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.142.5-4-2/data/tudresden/oapk_2023_tu_dresden_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Dresden" & !is.na(my.apc_new$institution),]
...
```{r tree_dresden_2025_01_29_full}
...
```{r box_dresden_2025_01_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dresden_2025_01_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
