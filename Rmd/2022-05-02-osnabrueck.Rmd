...
The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles in 2021. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_osnabrueck_2022_05_02_full}
...
```{r box_osnabrueck_2022_05_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_osnabrueck_2022_05_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
