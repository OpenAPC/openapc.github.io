...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unifrankfurt/open_apc_2018jul-dez_final_enriched.csv"))
...
```{r tree_frankfurt_2019_04_05_full}
...
```{r box_frankfurt_2019_04_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
