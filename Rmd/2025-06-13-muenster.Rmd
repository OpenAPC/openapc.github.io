...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.156.7-7-2/data/unimuenster/oapk_2023_m%C3%BCnster_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Münster U" & !is.na(my.apc_new$institution),]
...
```{r tree_muenster_2025_06_13_full}
...
```{r box_muenster_2025_06_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_muenster_2025_06_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
