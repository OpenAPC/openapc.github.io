...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/mluhalle/openAPC_MLU_enriched.csv"))
...
```{r box_mlu_2020_06_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mlu_2020_06_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
