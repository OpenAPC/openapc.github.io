...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioulu/University_of_Oulu_APC_end_2022_enriched.csv"))
...
```{r box_oulu_2023_03_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oulu_2023_03_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
