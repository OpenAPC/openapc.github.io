...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.1.1-0-1-fixed/data/apc_de.csv"))
my.apc <- my.apc[246811:248467,]
...
```{r tree_couperin_2026_02_20_full}
...
```{r box_couperin_2026_02_20_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
