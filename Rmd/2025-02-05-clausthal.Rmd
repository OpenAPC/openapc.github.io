...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.143.5-4-2/data/tuclausthal/oapk_2023_tu_clausthal_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Clausthal" & !is.na(my.apc_new$institution),]
...
```{r tree_clausthal_2025_02_05_full}
...
```{r box_clausthal_2025_02_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_clausthal_2025_02_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
