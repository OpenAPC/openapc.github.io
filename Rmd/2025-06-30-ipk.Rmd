...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-IPK",]
...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.161.2-1-0/data/ipk/oapk_2023_leibniz-ipk_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-IPK",]
...
```{r box_ipk_2025_06_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ipk_2025_06_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
