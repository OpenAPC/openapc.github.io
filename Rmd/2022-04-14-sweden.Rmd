...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "University of Gävle",]
my.apc <- droplevels(my.apc)
my.apc_new <- my.apc[my.apc$period == 2021,]
my.apc_new <- droplevels(my.apc_new)
```

The dataset covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2021. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_natlibswe_2022_04_14_full}
...
```{r box_natlibswe_2022_04_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_natlibswe_2022_04_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
