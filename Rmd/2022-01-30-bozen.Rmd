...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibozen/2021_APC_UNIBZ_enriched.csv")
...
```{r box_bozen_2022_01_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bozen_2022_01_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
