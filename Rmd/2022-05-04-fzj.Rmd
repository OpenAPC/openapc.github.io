...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fzj/FZJ2021_enriched.csv"))
...
```{r box_fzj_2022_05_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2022_05_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
