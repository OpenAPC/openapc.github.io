...
my.apc_2018 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/hzdr/openapc2018_enriched.csv"))
my.apc_2018 <- my.apc_2018[!is.na(my.apc_2018$institution),]
...
```{r box_hzdr_2019_03_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hzdr_2019_03_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
