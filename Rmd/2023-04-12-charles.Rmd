...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charlesuniversity/OpenAPC_dataset_2021_APC_enriched.csv"))
...
```{r tree_charles_2023_04_12_full}
...
```{r box_charles_2023_04_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charles_2023_04_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
