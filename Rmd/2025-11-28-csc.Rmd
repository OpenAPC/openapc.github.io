...
download_apc <- function(path = NULL, dir = "tmp", file = "apc_de.csv"){
  if(is.null(path)) {
    path <- c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.166.5-4-5/data/apc_de.csv")
    } 
  dir.create(dir) 
...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.166.5-4-5/data/csc/journals_enriched.csv"))
...
```{r box_csc_2025_11_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_csc_2025_11_28_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
