...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unieasternfinland/uef_openapc_2022_enriched.csv"))
...
```{r tree_eastern_finland_2023_03_17_full}
...
```{r box_eastern_finland_2023_03_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_eastern_finland_2023_03_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
