...
my.apc_new <- my.apc[my.apc$period %in% c(2016, 2017, 2018),]
...
```{r box_zurich_2020_09_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zurich_2020_09_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
