...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-ZMT",]
my.apc <- droplevels(my.apc)
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.161.3-2-0/data/zmt/oapk_2023_leibniz-zmt_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-ZMT",]
...
```{r box_zmt_2025_07_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zmt_2025_07_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
