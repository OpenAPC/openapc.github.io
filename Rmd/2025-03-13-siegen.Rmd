...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.10-8-2/data/unisiegen/oapk_2023_siegen_u_enriched.csv"))
...
```{r box_siegen_2025_03_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_siegen_2025_03_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
