...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Museum für Naturkunde Berlin",]
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.155.3-1-0/data/mfn_berlin/oapk_2023_museum_f%C3%BCr_naturkunde_berlin_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Museum für Naturkunde Berlin",]
...
```{r tree_mfn_berlin_2025_06_04_full}
...
```{r box_mfn_berlin_2025_06_04_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mfn_berlin_2025_06_04_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
