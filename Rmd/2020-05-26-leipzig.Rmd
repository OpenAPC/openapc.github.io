...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unileipzig/UL_2019_apc_enriched.csv"))
...
```{r tree_leipzig_2020_05_26_full}
...
```{r box_leipzig_2020_05_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_leipzig_2020_05_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
