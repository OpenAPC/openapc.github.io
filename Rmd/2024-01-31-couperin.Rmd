...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.119.5-11-1/data/apc_de.csv"))
my.apc <- my.apc[202605:202913,]
...
```{r tree_couperin_2024_01_31_full}
...
```{r box_couperin_2024_01_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
