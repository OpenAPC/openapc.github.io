...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "MDC" & my.apc$period == 2015, ]
...
```{r box_mdc_year-2016-05-12, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mdc_publisher-2016-05-12, echo = FALSE, message = FALSE}
require(ggplot2)
