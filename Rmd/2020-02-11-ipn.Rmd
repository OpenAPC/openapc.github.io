...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ipn/2019_IPN_openAPC_enriched.csv"))
...
```{r box_ipn_2020_02_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ipn_2020_02_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
