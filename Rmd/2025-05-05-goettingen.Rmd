...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.153.10-6-3/data/unigoettingen/oapk_2023_goettingen_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Goettingen U",]
my.apc_new <- droplevels(my.apc_new)
```

The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. Please note that BPCs are aggregated in OpenAPC's [BPC](https://github.com/OpenAPC/openapc-de/blob/master/data/bpc.csv) dataset and are not listed here.
...
```{r additional_costs_goettingen_2025_05_05_full, echo = FALSE, message = FALSE}
...
```{r tree_goettingen_2025_05_05_full}
...
```{r box_goettingen_2025_05_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_goettingen_2025_05_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
