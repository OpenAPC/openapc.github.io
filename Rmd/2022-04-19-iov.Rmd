...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/iov-irccs/OpenAPC_2021_IOV_enriched.csv"))
...
```{r box_iov_2022_04_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_iov_2022_04_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
