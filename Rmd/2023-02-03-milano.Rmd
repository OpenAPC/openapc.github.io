...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimilano/University_of_Milan_APC_2022_enriched.csv"))
...
```{r box_milan_2023_02_03_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_milan_2023_02_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
