...
my.apc_18 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/dlr/DLRopenAPC_2018_enriched.csv"))
my.apc_18 <- my.apc_18[161:172,]
my.apc_19 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/dlr/DLRopenAPC_2019_enriched.csv"))

my.apc_new <- rbind(my.apc_18, my.apc_19)
my.apc_new <- my.apc_new[my.apc_new$institution == "DLR" & !is.na(my.apc_new$institution),]
...
```{r box_dlr_2020_09_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dlr_2020_09_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
