...
The new data covers publication fees for `r format(nrow(my.apc_2018), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_2018$euro)`€ and the average fee is `r sum(my.apc_2018$euro)/nrow(my.apc_2018)`€.
...
```{r tree_stuttgart_2019_02_22_full}
...
```{r box_stuttgart_2019_02_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_stuttgart_2019_02_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
