...
my.apc_wiley <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/ACP_FU_Wiley_GoldOA_2022_enriched.csv"))
my.apc_sn <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/ACP_SpringerNature_GoldOA_2022_enriched.csv"))
...
```{r tree_fuberlin_2023_03_13_full}
...
```{r box_fuberlin_2023_03_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2023_03_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
