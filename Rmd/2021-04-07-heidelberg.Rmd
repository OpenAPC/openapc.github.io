...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniheidelberg/OpenAPC_HeidelbergU_Datenlieferung_2021_enriched.csv"))
...
```{r tree_heidelberg_2021_04_07_full}
...
```{r box_heidelberg_2021_04_07_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_heidelberg_2021_04_07_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
