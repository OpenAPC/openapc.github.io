...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/Open_APC_ETH_Zurich_2012-2019_enriched.csv"))
...
```{r box_ethz_2021_03_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2021_03_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
