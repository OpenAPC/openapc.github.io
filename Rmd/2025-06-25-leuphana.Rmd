...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leuphana University of Lüneburg",]
...
```{r tree_leuphana_2025_06_25_full}
...
```{r box_leuphana_2025_06_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
