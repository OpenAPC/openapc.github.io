...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/APC_FU_Berlin_2019_Nachzuegler_enriched.csv"))
...
```{r tree_fuberlin_2020_04_01_full}
...
```{r box_fuberlin_2020_04_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2020_04_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
