...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unisalzburg/Open_APC_UB_Salzburg_2018-2020_enriched.csv"))
...
```{r tree_salzburg_2021_02_03_full}
...
```{r box_salzburg_2021_02_03_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2021_02_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
