...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution %in% c("Université Clermont Auvergne"),]
...
```{r tree_couperin_2018_08_06_full}
...
```{r box_couperin_2018_08_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
