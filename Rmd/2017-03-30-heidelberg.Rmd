...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniheidelberg/openAPC_Datenlieferung_2015-2016-2017_enriched.csv"))
...
```{r tree_heidelberg_2017_03_30_full}
...
```{r box_heidelberg_2017_03_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_heidelberg_2017_03_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
