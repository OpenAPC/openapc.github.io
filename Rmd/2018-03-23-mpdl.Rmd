...
my.apc_various_2017 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/mpg/openapc_mpg_frontiers_2017_enriched.csv"))
...
The new dataset covers publication fees for `r format(nrow(my.apc_various_2017), big.mark =",")` articles published by MPG researchers with Frontiers. Total expenditure amounts to `r sum(my.apc_various_2017$euro)`€ and the average fee is `r sum(my.apc_various_2017$euro)/nrow(my.apc_various_2017)`€.
...
```{r box_mpdl_2018_03_23_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mpdl_2018_03_23_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
