...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibozen/OPEN_APC_2023_unibz_enriched.csv")
...
```{r box_bozen_2024_04_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bozen_2024_04_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
