...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.2.1-1-1/data/apc_de.csv"))
my.apc <- my.apc[251570:251623,]
...
```{r tree_natlibswe_2026_04_10_full}
...
```{r box_natlibswe_2026_04_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
