...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unisalzburg/Open_APC_UB_Salzburg_2024_Q1-2_enriched.csv"))
...
```{r tree_salzburg_2024_08_06_full}
...
```{r box_salzburg_2024_08_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2024_08_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
