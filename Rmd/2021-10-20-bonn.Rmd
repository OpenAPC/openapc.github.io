...
my.apc_wiley <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibonn/OpenAPC_DEAL_Gold_OA_Springer_Bonn_2020_enriched.csv"))
my.apc_sn <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibonn/OpenAPC_DEAL_Gold_OA_Wiley_Bonn_2020_enriched.csv"))
...
```{r box_bonn_2021_10_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bonn_2021_10_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
