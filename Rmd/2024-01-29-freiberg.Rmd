...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tufreiberg/TUBAF_2023_enriched.csv"))
...
```{r tree_freiberg_2024_01_29_full}
...
```{r box_freiberg_2024_01_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_freiberg_2024_01_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
