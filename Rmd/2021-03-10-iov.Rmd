...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/iov-irccs/OpenAPC_2020_IOV_enriched.csv"))
...
```{r box_iov_2021_03_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_iov_2021_03_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
