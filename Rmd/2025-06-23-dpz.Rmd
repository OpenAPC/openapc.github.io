...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-DPZ",]
my.apc <- droplevels(my.apc)
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.8-6-3/data/dpz/oapk_2023_leibniz-dpz_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-DPZ",]
...
```{r box_dpz_2025_06_23_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dpz_2025_06_23_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
