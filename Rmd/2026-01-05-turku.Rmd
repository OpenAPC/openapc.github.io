...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/OA-kosten-UNITURKU-Mai_August_2025_enriched.csv"))
...
```{r box_turku_2026_01_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2026_01_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
