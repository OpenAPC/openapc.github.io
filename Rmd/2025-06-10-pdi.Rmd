...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.156.3-4-1/data/pdi/oapk_2023_paul-drude-institut_f%C3%BCr_festk%C3%B6rperelektronik_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Paul-Drude-Institut für Festkörperelektronik",]
...
```{r box_pdi_2025_06_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_pdi_2025_06_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
