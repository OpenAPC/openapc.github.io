...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/bfh/2021_OpenAPC_BernUniversityofAppliedSciences_enriched.csv"))
...
```{r box_bfh_2022_07_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bfh_2022_07_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
