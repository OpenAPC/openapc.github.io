...
my.apc_new <- my.apc[my.apc$period %in% c(2022, 2023),]
...
```{r box_ifw_2023_06_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ifw_2023_06_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
