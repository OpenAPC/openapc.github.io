...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibamberg/oapk_2022_bamberg_u_enriched.csv"))
...
```{r tree_bamberg_2023_12_14_full}
...
```{r box_bamberg_2023_12_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bamberg_2023_12_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
