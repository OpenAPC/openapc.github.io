...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "Bamberg U" & my.apc$period == 2015, ]
...
```{r box_bamberg_year_2016-04-27, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bamberg_publisher_2016-04-27, echo = FALSE, message = FALSE}
require(ggplot2)
