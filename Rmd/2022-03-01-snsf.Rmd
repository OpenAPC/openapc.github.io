...
The updated data set provided by the SNSF covers more publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2021. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€. The following table provides an overview:
