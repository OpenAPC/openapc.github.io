...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unipassau/oapk_2022_passau_u_enriched.csv"))
...
```{r box_passau_2023_12_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_passau_2023_12_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
