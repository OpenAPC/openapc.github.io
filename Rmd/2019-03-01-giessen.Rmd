...
my.apc_2018 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/jlu_giessen/gie%C3%9Fen_2018_enriched.csv"))
...
```{r tree_giessen_2019_03_01_full}
...
```{r box_giessen_2019_03_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_giessen_2019_03_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
