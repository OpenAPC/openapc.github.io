...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ipn/2020-2021_IPN_OpenAPC_enriched.csv"))
...
```{r box_ipn_2022_10_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ipn_2022_10_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
