...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibarcelona/APAO_UB2018_enriched.csv"))
...
```{r tree_barcelona_2020_02_03_full}
...
```{r box_barcelona_2020_02_03_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_barcelona_2020_02_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
