...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.0.2-0-1/data/apc_de.csv"))
my.apc_new <- my.apc_new[246580:246628,]
...
```{r tree_salzburg_2026_02_17_full}
...
```{r box_salzburg_2026_02_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2026_02_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
