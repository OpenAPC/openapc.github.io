...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibern/Reporting_University_of_Bern_OpenAPC_2025_enriched.csv"))
...
```{r box_bern_2026_03_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bern_2026_03_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
