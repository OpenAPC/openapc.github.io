...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "University of Bern",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v5.0.3-0-1/data/unibern/Reporting_University_of_Bern_OpenAPC_2025_enriched.csv"))
...
```{r box_bern_2026_02_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bern_2026_02_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
