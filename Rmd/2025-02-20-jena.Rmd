...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.146.1-2-0/data/fsu/oapk_2023_friedrich-schiller-universit%C3%A4t_jena_enriched.csv"))
...
```{r box_jena_2025_02_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_jena_2025_02_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
