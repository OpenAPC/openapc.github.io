...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.144.3-3-1/data/dipf/oapk_2023_dipf_enriched.csv"))
...
```{r box_dipf_2025_02_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dipf_2025_02_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
