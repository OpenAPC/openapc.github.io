...
```{r tree_openapc_se_2022_02_01_full}
...
```{r box_openapc_se_2022_02_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_openapc_se_2022_02_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
