...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.36.2-2-0/data/qatar_national_library/Open_APC_20211118_enriched.csv"))
...
```{r box_qnl_2021_11_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_qnl_2021_11_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
