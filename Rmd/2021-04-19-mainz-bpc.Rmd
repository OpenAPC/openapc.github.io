...
my.bpc <- download_bpc()
my.bpc <- my.bpc[my.bpc$institution == "JGU Mainz",]
...
```{r tree_mainz_2021_04_19_bpc_full}
...
```{r box_mainz_2021_04_19_bpc_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2021_04_19_bpc_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.bpc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
