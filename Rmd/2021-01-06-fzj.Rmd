...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fzj/FZJ2019_enriched.csv"))
...
```{r box_fzj_2021_01_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2021_01_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
