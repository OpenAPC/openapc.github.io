...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "TU Braunschweig",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tubraunschweig/2024-03-11_OpenAPC_TUBS-2021-2022-2023_Gold-Artikel_enriched.csv"))
...
```{r tree_braunschweig_2024_04_02_full}
...
```{r box_braunschweig_2024_04_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_braunschweig_2024_04_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
