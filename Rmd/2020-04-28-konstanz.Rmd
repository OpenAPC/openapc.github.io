...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikonstanz/Meldung_OpenAPC_2018_2019_enriched.csv"))
...
```{r tree_konstanz_2020_04_28_full}
...
```{r box_konstanz_2020_04_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_konstanz_2020_04_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
