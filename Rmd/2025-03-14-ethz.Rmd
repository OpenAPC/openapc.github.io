...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/ETHZ_OpenAPC_2024_enriched.csv"))
...
```{r box_ethz_2025_03_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2025_03_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
