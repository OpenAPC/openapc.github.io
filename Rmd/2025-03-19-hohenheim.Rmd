...
```{r additional_costs_hohenheim_2025_04_02_full, echo = FALSE, message = FALSE}
...
```{r tree_hohenheim_2025_04_02_full}
...
```{r box_hohenheim_2025_04_02_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hohenheim_2025_04_02_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
  mutate(publisher = str_replace(publisher, ".+\\((\\w+)\\)", "\\1"))
