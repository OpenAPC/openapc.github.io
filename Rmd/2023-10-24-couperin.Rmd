...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.96.3-3-3/data/apc_de.csv"))
my.apc <- my.apc[189759:190663,]
...
```{r tree_couperin_2023_10_24_full}
...
```{r box_couperin_2023_10_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
