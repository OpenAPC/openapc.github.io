...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Leibniz-IGB",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/igb/OpenAPC_LeibnizIGB_2020_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-IGB",]
...
```{r box_igb_2021_03_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_igb_2021_03_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
