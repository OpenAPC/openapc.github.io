...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/oapk_2023_jgu_mainz_enriched.csv"))
...
```{r box_mainz_2025_06_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2025_06_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
