...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/jlu_giessen/oapk_2022_giessen_u_enriched.csv"))
...
```{r tree_giessen_2024_01_05_full}
...
```{r box_giessen_2024_01_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_giessen_2024_01_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
