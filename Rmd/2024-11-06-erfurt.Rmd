...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.134.2-1-1/data/unierfurt/apc_unierfurt_2022_enriched.csv"))
...
```{r box_erfurt_2024_11_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_erfurt_2024_11_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
