...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "FP7 Post-Grant OA Pilot",]
...
```{r box_fp7_2016_11_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fp7_2016_11_2_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
