...
my.apc_new_23 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/heads/master/data/hsluzern/openAPC-HochschuleLuzern-2023_journals_enriched.csv"))
my.apc_new_24 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/heads/master/data/hsluzern/openAPC-HochschuleLuzern-2024_journals_enriched.csv"))
my.apc_new <- rbind(my.apc_new_23, my.apc_new_24)
...
```{r box_hslu_2025_07_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hslu_2025_07_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
