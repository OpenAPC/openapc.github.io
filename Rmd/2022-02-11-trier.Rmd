...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.42.6-1-1/data/unitrier/OpenAPC-2020_enriched.csv"))
...
```{r box_trier_2022_02_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_trier_2022_02_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
