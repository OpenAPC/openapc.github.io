...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.102.4-0-1/data/tubraunschweig/oapk_2022_tu_braunschweig_enriched.csv"))
...
```{r tree_braunschweig_2023_12_19_full}
...
```{r box_braunschweig_2023_12_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_braunschweig_2023_12_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
