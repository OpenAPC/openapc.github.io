...
my.apc_new <- my.apc[my.apc$period %in% c(2012, 2013, 2014, 2015),]
...
```{r box_zurich_2020_10_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zurich_2020_10_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
