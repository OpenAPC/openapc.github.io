...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "University of Education Schwaebisch Gmuend",]
...
```{r tree_schwaebisch_gmuend_2025_01_22_full}
...
```{r box_schwaebisch_gmuend_2025_01_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
