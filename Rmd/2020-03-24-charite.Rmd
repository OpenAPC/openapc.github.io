...
```{r tree_charite_2020_03_24_full}
...
```{r box_charite_2020_03_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charite_2020_03_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
