...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unileipzig/OpenAPC_LeipzigU_Gold_2020_enriched.csv"))
...
```{r tree_leipzig_2021_10_15_full}
...
```{r box_leipzig_2021_10_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_leipzig_2021_10_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
