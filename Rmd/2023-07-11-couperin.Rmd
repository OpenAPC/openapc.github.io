...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.91.1-0-1/data/apc_de.csv"))
my.apc <- my.apc[186157:186433,]
...
```{r tree_couperin_2023_07_11_full}
...
```{r box_couperin_2023_07_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
