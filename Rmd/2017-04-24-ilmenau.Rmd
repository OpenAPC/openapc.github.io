...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuilmenau/OpenAPC_TUIlm_2016_2_enriched.csv"))
my.apc <- download_apc()
...
```{r tree_ilmenau_2017_04_24_full}
...
```{r box_ilmenau_2017_04_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ilmenau_2017_04_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
