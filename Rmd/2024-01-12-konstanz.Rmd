...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unikonstanz/oapk_2022_konstanz_u_enriched.csv"))
...
```{r tree_konstanz_2024_01_12_full}
...
```{r box_konstanz_2024_01_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_konstanz_2024_01_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
