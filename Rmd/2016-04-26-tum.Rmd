...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "TU Muenchen" & my.apc$period == 2015, ]
...
```{r box_tum_year_2016-04-26, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tum_publisher_2016-04-26, echo = FALSE, message = FALSE}
require(ggplot2)
