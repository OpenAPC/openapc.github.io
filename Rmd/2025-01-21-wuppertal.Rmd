...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.138.2-2-0/data/uniwuppertal/oapk_2023_wuppertal_u_enriched.csv"))
...
```{r tree_wuppertal_2025_01_21_full}
...
```{r box_wuppertal_2025_01_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_wuppertal_2025_01_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
