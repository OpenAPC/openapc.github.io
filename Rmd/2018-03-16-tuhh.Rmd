...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/apc-tuhh-2017_enriched.csv"))
...
```{r box_tuhh_2018_03_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2018_03_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
