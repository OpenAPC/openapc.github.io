...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "TU Chemnitz" & my.apc$period == 2015, ]
my.apc_2015 <- droplevels(my.apc_2015)
my.apc <- my.apc[my.apc$institution == "TU Chemnitz", ]
my.apc <- droplevels(my.apc)
```

The new dataset extends Chemnitz's contribution for the last year to `r format(nrow(my.apc_2015), big.mark =",")` articles. Total 2015 expenditure amounts to `r sum(my.apc_2015$euro)`€ and the average fee is `r sum(my.apc_2015$euro)/nrow(my.apc_2015)`€.
...
```{r box_chemnitz_year_2016-05-17, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_chemnitz_publisher_2016-05-17, echo = FALSE, message = FALSE}
require(ggplot2)
