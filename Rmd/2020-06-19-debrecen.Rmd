...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unidebrecen/APC-University_of_Debrecen_CSV_2019_enriched.csv"))
...
```{r tree_debrecen_2020_06_19_full}
...
```{r box_debrecen_2020_06_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_debrecen_2020_06_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
