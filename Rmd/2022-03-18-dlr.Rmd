...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/dlr/DLRopenAPC_2021_enriched.csv"))
...
```{r box_dlr_2022_03_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dlr_2022_03_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
