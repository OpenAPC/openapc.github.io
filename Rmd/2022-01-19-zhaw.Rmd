...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/zhaw/20220118_OpenAPC_ZHAW_enriched.csv"))
...
```{r box_zhaw_2022_01_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
