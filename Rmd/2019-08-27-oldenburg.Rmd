...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20190826_enriched.csv"))
...
```{r tree_oldenburg_2019_08_27_full}
...
```{r box_oldenburg_2019_08_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2019_08_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
