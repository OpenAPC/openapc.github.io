...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fzj/FZJ2020_enriched.csv"))
...
```{r box_fzj_2021_12_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fzj_2021_12_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
