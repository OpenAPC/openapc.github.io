...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/leibnizfonds/leibnizfonds-enriched.csv"))
my.apc_new <- my.apc_new[1102:1173,]
my.apc_new <- my.apc_new[my.apc_new$institution == "Leibniz-Fonds",]
...
```{r tree_leibnizfonds_2024_05_06_full}
...
```{r box_leibnizfonds_2024_05_06_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_leibnizfonds_2024_05_06_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
