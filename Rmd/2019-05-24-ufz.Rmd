...
my.apc_old <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v3.62.2/data/ufz/ufz_2014_2017_enriched.csv"))
my.apc_old <- my.apc_old[my.apc_old$institution == "UFZ",]
...
```{r box_ufz_2019_05_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ufz_2019_05_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
