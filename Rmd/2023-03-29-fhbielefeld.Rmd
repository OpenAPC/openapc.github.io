...
my.apc <- my.apc[my.apc$institution == "Bielefeld FH",]
my.apc <- droplevels(my.apc)
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fhbielefeld/OpenAPC_Meldung_2022-01_papers_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Bielefeld FH",]
...
```{r tree_fhbielefeld_2023_03_29_full}
...
```{r box_fhbielefeld_2023_03_29_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fhbielefeld_2023_03_29_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
