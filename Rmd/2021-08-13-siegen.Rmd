...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unisiegen/Datenlieferung_Open_APC_Universit%C3%A4t_Siegen_2020_APC_enriched.csv"))
...
```{r box_siegen_2021_08_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_siegen_2021_08_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
