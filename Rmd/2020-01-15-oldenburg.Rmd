...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20200103_enriched.csv"))
...
```{r tree_oldenburg_2020_01_15_full}
...
```{r box_oldenburg_2020_01_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2020_01_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
