...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unitampere/Tampere_university_APC_2021_enriched.csv"))
...
```{r tree_tampere_2022_05_25_full}
...
```{r box_tampere_2022_05_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tampere_2022_05_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
