...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "CIRAD" & my.apc$period == 2021,]
...
```{r tree_couperin_2022_05_05_full}
...
```{r box_couperin_2022_05_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
