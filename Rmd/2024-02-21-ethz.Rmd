...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/ETHZ_OpenAPC_2023_Gold_and_Invoices_enriched.csv"))
...
```{r box_ethz_2024_02_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2024_02_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
