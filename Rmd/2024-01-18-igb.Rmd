...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/igb/oapk_2022_leibniz-igb_enriched.csv"))
...
```{r box_igb_2024_01_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_igb_2024_01_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
