...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unidebrecen/OPEN_APC-University_of_Debrecen_2020_enriched.csv"))
...
```{r tree_debrecen_2021_02_12_full}
...
```{r box_debrecen_2021_02_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_debrecen_2021_02_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
