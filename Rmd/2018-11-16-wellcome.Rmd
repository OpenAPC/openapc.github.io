...
my.apc <- download_apc()
my.apc_2017 <- my.apc[my.apc$institution == "Wellcome Trust" & my.apc$period == 2016, ]
...
```{r tree_wellcome_2018_11_16_full}
...
```{r box_wellcome_2018_11_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_wellcome_2018_11_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
