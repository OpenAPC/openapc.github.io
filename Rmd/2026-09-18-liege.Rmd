...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniliege/OpenAPC_ULiege_2025_enriched.csv"))
...
```{r box_liege_2026_09_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_liege_2026_09_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
