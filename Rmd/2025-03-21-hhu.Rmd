...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.14-12-3/data/hhu_duesseldorf/oapk_2023_hhu_d%C3%BCsseldorf_enriched.csv"))
...
```{r tree_hhu_düsseldorf_2025_03_21_full}
...
```{r box_hhu_düsseldorf_2025_03_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hhu_düsseldorf_2025_03_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
