...
my.apc_new <- download_apc("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibozen/20200204_openapc_unibz_2019_enriched.csv")
...
```{r box_bozen_2020_02_05_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bozen_2020_02_05_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
