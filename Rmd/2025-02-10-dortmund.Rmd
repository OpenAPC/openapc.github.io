...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.144.6-6-2/data/tudortmund/oapk_2023_dortmund_tu_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Dortmund TU",]
...
```{r tree_dortmund_2025_02_10_full}
...
```{r box_dortmund_2025_02_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dortmund_2025_02_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
