...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/heads/master/data/unimilano/openapc_unimi_2026_jan-jul09_enriched.csv"))
...
```{r tree_milano_u_2026_07_14_full}
...
```{r box_milano_u_2026_07_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_milano_u_2026_07_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
