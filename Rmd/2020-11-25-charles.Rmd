...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charlesuniversity/2019_Charles-University_APCs_enriched.csv"))
...
The new 2019 data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2019. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_charles_2020_11_24_full}
...
```{r box_charles_2020_11_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charles_2020_11_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
