...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.10-7-5/data/unimannheim/oapk_2023_mannheim_u_enriched.csv"))
...
```{r tree_mannheim_2025_06_24_full}
...
```{r box_mannheim_2025_06_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mannheim_2025_06_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
