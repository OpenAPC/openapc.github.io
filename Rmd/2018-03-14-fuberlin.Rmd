...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/APC_FU_Berlin_Fonds2017_Bielefeld_enriched.csv"))
...
```{r tree_fuberlin_2018_03_14_full}
...
```{r box_fuberlin_2018_03_14_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2018_03_14_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
