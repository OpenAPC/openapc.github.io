...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/zhdk/2021_ZHdK_APC_enriched.csv"))
...
```{r box_zhdk_2022_10_12_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_zhdk_2022_10_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
