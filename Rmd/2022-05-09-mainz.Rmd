...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/mainz_deal_springer_gold_2020_enriched.csv"))
...
```{r box_mainz_2022_05_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2022_05_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
