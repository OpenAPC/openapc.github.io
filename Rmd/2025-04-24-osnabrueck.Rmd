...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.153.3-3-1/data/uniosnabrueck/oapk_2023_osnabr%C3%BCck_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Osnabrück U",]
...
```{r tree_osnabrueck_2025_04_24_full}
...
```{r box_osnabrueck_2025_04_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_osnabrueck_2025_04_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
