...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/apc-tuhh-2018_enriched.csv"))
...
```{r box_tuhh_2019_03_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2019_03_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
