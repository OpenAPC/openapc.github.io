...
my.apc_new_16 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/Daten-OpenAPC-2016Ergaenzung_enriched.csv"))
my.apc_new_16 <- droplevels(my.apc_new_16)
my.apc_new_17 <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/Daten-OpenAPC-2017_enriched.csv"))
my.apc_new_17 <- droplevels(my.apc_new_17)
my.apc_new <- rbind(my.apc_new_16, my.apc_new_17)
```

The new datasets cover publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r box_mainz_2018_03_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2018_03_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
