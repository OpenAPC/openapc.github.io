...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20180717_enriched.csv"))
...
```{r tree_oldenburg_2018_08_10_full}
...
```{r box_oldenburg_2018_08_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2018_08_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
