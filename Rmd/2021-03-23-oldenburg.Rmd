...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unioldenburg/openapc_cvo_20210322_enriched.csv"))
...
```{r tree_oldenburg_2021_03_23_full}
...
```{r box_oldenburg_2021_03_23_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_oldenburg_2021_03_23_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
