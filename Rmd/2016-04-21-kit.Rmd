...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "KIT" & my.apc$period == 2015, ]
...
```{r box_kit_year-2016-04-21, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_kit_publisher-2016-04-21, echo = FALSE, message = FALSE}
require(ggplot2)
