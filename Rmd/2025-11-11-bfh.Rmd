...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/heads/master/data/bfh/Import_Formular_OpenACP_2024_enriched.csv"))
...
```{r box_bfh_2025_11_11_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bfh_2025_11_11_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
