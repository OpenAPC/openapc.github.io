...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "TU Bergakademie Freiberg",]
my.apc$publisher <- gsub("Institute of Electrical & Electronics Engineers \\(IEEE\\)", "IEEE", my.apc$publisher)
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.147.5-4-1/data/tufreiberg/TUBAF_2024_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "TU Bergakademie Freiberg",]
...
```{r tree_freiberg_2025_03_10_full}
...
```{r box_freiberg_2025_03_10_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_freiberg_2025_03_10_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
