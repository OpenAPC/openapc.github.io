...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.140.2-2-0/data/uniaugsburg/oapk_2023_augsburg_u_enriched.csv"))
...
```{r tree_augsburg_2025_01_22_full}
...
```{r box_augsburg_2025_01_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_augsburg_2025_01_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
