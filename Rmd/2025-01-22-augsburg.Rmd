...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Augsburg U",]
my.apc$publisher <- gsub("Association for Research in Vision and Ophthalmology \\(ARVO\\)", "ARVO", my.apc$publisher)
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.142.5-4-2-fixed/data/uniaugsburg/oapk_2023_augsburg_u_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "Augsburg U",]
...
```{r tree_augsburg_2025_01_30_full}
...
```{r box_augsburg_2025_01_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_augsburg_2025_01_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
