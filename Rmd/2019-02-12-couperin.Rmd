...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$period == 2017 & my.apc$institution %in% c("Université Claude Bernard Lyon 1", "Université Paris Diderot (Paris VII)", "Université Toulouse III - Paul Sabatier", "Université de La Rochelle"),]
...
```{r tree_couperin_2019_02_12_full}
...
```{r box_couperin_2019_02_12_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
