...
The [University of Liège](hhttps://www.uliege.be/) has provided its APC expenditures for the 2020 period
...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniliege/OpenAPC_ULiege_2020_enriched.csv"))
...
```{r box_liege_2021_06_22_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_liege_2021_06_22_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
