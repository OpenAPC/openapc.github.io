...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/charlesuniversity/CUNI_OpenAPC_dataset_2021_APC_v2_enriched.csv"))
...
The new data set covers publication fees for `r format(nrow(my.apc_new), big.mark =",")` articles published in 2021. Total expenditure amounts to `r sum(my.apc_new$euro)`€ and the average fee is `r sum(my.apc_new$euro)/nrow(my.apc_new)`€.
...
```{r tree_charles_2023_04_27_full}
...
```{r box_charles_2023_04_27_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_charles_2023_04_27_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
