...
The new 2017 dataset covers publication fees for `r format(nrow(my.apc_2017), big.mark =",")` articles. Total expenditure amounts to `r sum(my.apc_2017$euro)`€ and the average fee is `r sum(my.apc_2017$euro)/nrow(my.apc_2017)`€.
...
```{r box_ulm_2018_01_31_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ulm_2018_01_31_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
