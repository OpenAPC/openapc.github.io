...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.158.2-2-1/data/mhbfontane/oapk_2023_mhb_fontane_enriched.csv"))
my.apc_new <- my.apc_new[my.apc_new$institution == "MHB Fontane" & !is.na(my.apc_new$institution),]
...
```{r box_mhb_2025_06_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mhb_2025_06_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
