...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.159.2-2-1/data/unihannover/oapk_2023_hannover_u_enriched.csv"))
...
```{r tree_hannover_2025_06_25_full}
...
```{r box_hannover_2025_06_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_hannover_2025_06_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
