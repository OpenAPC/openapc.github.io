...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.163.4-2-1/data/apc_de.csv"))
my.apc_new <- my.apc_new[250801:250822,]
...
```{r tree_salzburg_2025_07_23_full}
...
```{r box_salzburg_2025_07_23_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2025_07_23_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
