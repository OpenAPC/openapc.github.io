...
my.apc <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.97.4-1-1/data/apc_de.csv"))
my.apc <- my.apc[192918:193429,]
...
```{r tree_couperin_2023_11_17_full}
...
```{r box_couperin_2023_11_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
d_frame = data.frame(table(my.apc$publisher,  dnn="Publisher"))                 
d_frame = d_frame[with(d_frame, order(-Freq, Publisher)), ]
