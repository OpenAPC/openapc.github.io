...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tudresden/TUD_2019_2_enriched.csv"))
...
```{r tree_dresden_2020_05_26_full}
...
```{r box_dresden_2020_05_26_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dresden_2020_05_26_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
