...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/v4.147.15-13-4/data/apc_de.csv"))
my.apc_new <- my.apc_new[240196:240356,]
...
```{r additional_costs_greifswald_2025_03_24_full, echo = FALSE, message = FALSE}
...
```{r tree_greifswald_2025_03_24_full}
...
```{r box_greifswald_2025_03_24_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_greifswald_2025_03_24_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
