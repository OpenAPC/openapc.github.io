...
my.bpc_new <- download_bpc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuberlin/BPC_22_enriched.csv"))
...
```{r tree_tuberlin_2023_02_02_bpc_full}
...
```{r box_tuberlin_2023_02_02_bpc_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuberlin_2023_02_02_bpc_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
