...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "PIK-Potsdam",]
my.apc$publisher <- gsub("American Association for the Advancement of Science \\(AAAS\\)", "AAAS", my.apc$publisher)
my.apc <- droplevels(my.apc)

my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/pik-potsdam/oapk_2022_pik-potsdam_enriched.csv"))
...
```{r box_pik_2023_12_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_pik_2023_12_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
