...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.137.3-1-2/data/unimilano/openapc_unimi_2024_jul-dec_enriched.csv"))
...
```{r tree_milano_u_2025_01_16_full}
...
```{r box_milano_u_2025_01_16_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_milano_u_2025_01_16_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
