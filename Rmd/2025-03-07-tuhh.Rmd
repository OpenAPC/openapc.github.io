...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tuhh/openAPC_2024_tuhh_enriched.csv"))
...
```{r box_tuhh_2025_03_18_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_tuhh_2025_03_18_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
