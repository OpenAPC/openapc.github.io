...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Forschungsinstitut für Nutztierbiologie",]
my.apc <- droplevels(my.apc)

```

The initial data set provided by the FBN covers publication fees for `r format(nrow(my.apc), big.mark =",")` articles, total expenditure amounts to `r sum(my.apc$euro)`€ and the average fee is `r sum(my.apc$euro)/nrow(my.apc)`€.
...
```{r box_fbn_2025_03_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
