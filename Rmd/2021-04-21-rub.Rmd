...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/rub/rub_apc_2020_enriched.csv"))
...
```{r box_rub_2021_04_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_rub_2021_04_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
