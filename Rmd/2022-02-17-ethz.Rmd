...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/ethz/ETHZ_OpenAPC_2021_Gold_Hybrid_enriched.csv"))
...
```{r box_ethz_2022_02_17_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ethz_2022_02_17_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
