...
my.apc_wiley <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/ACP_FU_Wiley_GoldOA_2021_enriched.csv"))
my.apc_sn <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/ACP_SpringerNature_GoldOA_2021_enriched.csv"))
...
```{r tree_fuberlin_2023_05_09_full}
...
```{r box_fuberlin_2023_05_09_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2023_05_09_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
