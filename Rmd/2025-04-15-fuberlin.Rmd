...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.150.4-4-0/data/fuberlin/oapk_2023_fu_berlin_enriched.csv"))
...
```{r tree_fuberlin_2025_04_15_full}
...
```{r box_fuberlin_2025_04_15_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2025_04_15_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
