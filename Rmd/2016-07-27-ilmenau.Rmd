...
my.apc <- download_apc()
my.apc_2016 <- my.apc[my.apc$institution == "TU Ilmenau" & my.apc$period == 2016, ]
my.apc_2016 <- droplevels(my.apc_2016)
my.apc <- my.apc[my.apc$institution == "TU Ilmenau", ]
my.apc <- droplevels(my.apc)
```

The new dataset covers publication fees for `r format(nrow(my.apc_2016), big.mark =",")` articles, which the fund covered in 2016 so far. Total expenditure amounts to `r sum(my.apc_2016$euro)`€ and the average fee is `r sum(my.apc_2016$euro)/nrow(my.apc_2016)`€.
...
## my.apc_2016$publisher <- factor(my.apc_2016$publisher, levels = c(rownames(data.frame(rev(sort(table(my.apc_2016$publisher)))))))
...
```{r box_ilmenau_year_2016-07-27, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_ilmenau_publisher_2016-07-27, echo = FALSE, message = FALSE}
require(ggplot2)
