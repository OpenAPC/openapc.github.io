...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.163.12-9-5/data/unibi/unibi_2024_enriched.csv"))
...
```{r tree_bielefeld_2025_08_21_full}
...
```{r box_bielefeld_2025_08_21_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bielefeld_2025_08_21_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
