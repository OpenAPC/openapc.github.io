...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/huberlin/APC_HU_BERLIN_2020_enriched.csv"))
my.apc_new <- my.apc_new[5:129,]
...
```{r tree_huberlin_2021_04_01_full}
...
```{r box_huberlin_2021_04_01_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_huberlin_2021_04_01_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
