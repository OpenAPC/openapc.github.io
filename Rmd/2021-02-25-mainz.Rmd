...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unimainz/Daten-OpenAPC-2020_enriched.csv"))
...
```{r box_mainz_2021_02_25_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_mainz_2021_02_25_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
