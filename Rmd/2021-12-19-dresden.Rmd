...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/tudresden/TUD_2020_enriched.csv"))
...
```{r tree_dresden_2021_12_19_full}
...
```{r box_dresden_2021_12_19_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_dresden_2021_12_19_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
