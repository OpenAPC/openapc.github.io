...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/uniturku/oa-kosten-univesitat-von-turku-Jan-April2020-csv_enriched.csv"))
...
```{r box_turku_2020_10_20_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_turku_2020_10_20_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
