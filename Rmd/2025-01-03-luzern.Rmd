...
my.apc <- download_apc()
my.apc <- my.apc[my.apc$institution == "Universität Luzern",]
...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/refs/tags/v4.136.3-1-1/data/uniluzern/unilu_openapc-2024-08-20_apc_enriched.csv"))
...
```{r tree_luzern_u_2025_01_03_full}
...
```{r box_luzern_u_2025_01_03_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_luzern_u_2025_01_03_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
require(tidyverse)
my.apc <- my.apc %>%
