...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unisalzburg/Open_APC_UB_Salzburg_2020-2021_enriched.csv"))
...
```{r tree_salzburg_2022_01_28_full}
...
```{r box_salzburg_2022_01_28_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_salzburg_2022_01_28_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
