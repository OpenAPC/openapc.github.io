...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/unibonn/OpenAPC_Gold_OA_gesamt_Bonn_2022_enriched.csv"))
...
```{r box_bonn_2023_07_13_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_bonn_2023_07_13_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
