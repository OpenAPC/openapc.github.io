...
my.apc <- download_apc()
my.apc_2015 <- my.apc[my.apc$institution == "INM - Leibniz-Institut für Neue Materialien" & my.apc$period == 2015, ]
my.apc_2015 <- droplevels(my.apc_2015)
my.apc <- my.apc[my.apc$institution == "INM - Leibniz-Institut für Neue Materialien", ]
my.apc <- droplevels(my.apc)
```

The new dataset covers publication fees for `r format(nrow(my.apc_2015), big.mark =",")` articles. Total expenditure for the 2015 period amounts to `r sum(my.apc_2015$euro)`€ and the average fee is `r sum(my.apc_2015$euro)/nrow(my.apc_2015)`€.
...
```{r box_inm_year_2016-07-26, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_inm_publisher_2016-07-26, echo = FALSE, message = FALSE}
require(ggplot2)
