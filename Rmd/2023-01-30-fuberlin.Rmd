...
my.apc_new <- download_apc(c("https://raw.githubusercontent.com/OpenAPC/openapc-de/master/data/fuberlin/APC_FU_2022_enriched.csv"))
...
```{r tree_fuberlin_2023_01_30_full}
...
```{r box_fuberlin_2023_01_30_year_full, echo=FALSE, message = FALSE}
require(ggplot2)
...
```{r box_fuberlin_2023_01_30_publisher_full, echo = FALSE, message = FALSE}
require(ggplot2)
